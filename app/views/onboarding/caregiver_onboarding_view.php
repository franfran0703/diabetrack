...
<div class="ob-wrap">
    ...
    <div class="ob-steps" id="ob-steps">
        <div class="ob-step">
            ...
            <span class="ob-step-label active" id="lbl-1">Your Details</span>
        </div>
    ...
    <div class="ob-card">
        ...
        <div class="ob-panel active" id="panel-1">
            <div class="ob-heading">Tell us about <span>yourself.</span></div>
            <div class="ob-sub">Just your basic contact info. All fields are optional.</div>

            <div class="ob-tip">
                <i class="bi bi-info-circle-fill"></i>
                <span>You'll specify your relationship to each patient when you send them a link request.</span>
            </div>

            <div class="ob-field">
                <label class="ob-label">Contact Number</label>
                <input class="ob-input" type="text" id="contact_number" name="contact_number" placeholder="e.g. 09171234567">
            </div>

            <div class="ob-field">
                <label class="ob-label">Address</label>
                <input class="ob-input" type="text" id="address" name="address" placeholder="e.g. Iloilo City, Philippines">
            </div>
        ...
        <div class="ob-panel" id="panel-2">
            ...
            <div class="ob-success-text">
                ...
                <div class="ob-sub">Your profile is ready. Link a patient from your dashboard to get started.</div>
            </div>
