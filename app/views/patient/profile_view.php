...
<div class="pp-page">
    ...
    <div class="pp-identity">
        ...
        <div class="pp-identity-info">
            <div class="pp-identity-name"><?= htmlspecialchars($user['name']) ?></div>
                    ...
                    <form method="POST" action="/diabetrack/public/patient/updateProfile">
                        ...
                        <div class="pp-form-2col">
                            <div class="pp-field">
                                ...
                                <input class="pp-input" type="text" name="name"
                ...
                <div class="pp-panel-body">
                    <form method="POST" action="/diabetrack/public/patient/updateProfile">
                        ...
                        <div class="pp-field">
                            ...
                            <input class="pp-input" type="password" name="current_password"
                                   placeholder="Enter your current password" required>
                        </div>
                        <div class="pp-form-2col">
                            <div class="pp-field">
                                <label class="pp-field-label">New Password</label>
                                <input class="pp-input" type="password" name="new_password"
                            ...
                            <div class="pp-field">
                                ...
                                <input class="pp-input" type="password" name="confirm_password"
                        ...
                        <div class="pp-person-list">
                            <?php foreach ($caregivers as $cg): ?>
                                <div class="pp-person-row">
                                    ...
                                    <div>
                                        <div class="pp-person-name"><?= htmlspecialchars($cg['name']) ?></div>
                                        <div class="pp-person-meta">
                                            <?= htmlspecialchars($cg['email']) ?> · Linked <?= date('M d, Y', strtotime($cg['linked_at'])) ?>
                                        </div>
                                    </div>
                                    <?php if ($cg['status'] === 'active'): ?>
